...
* `name` - (Optional) The name of the Neptune event subscription. By default generated by ytofu.
...
```bash
ytofu import aws_neptune_event_subscription.example my-event-subscription
```
