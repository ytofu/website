...
* `identifier` - (Optional, Forces new resource) The identifier for the neptune instance, if omitted, ytofu will assign a random, unique identifier.
...
```bash
ytofu import aws_neptune_cluster_instance.example my-instance
```
