...
ytofu resource for managing an AWS DynamoDB Table Export. ytofu will wait until the Table export reaches a status of `COMPLETED` or `FAILED`.
...
```bash
ytofu import aws_dynamodb_table_export.example arn:aws:dynamodb:us-west-2:12345678911:table/my-table-1/export/01580735656614-2c2f422e
```
