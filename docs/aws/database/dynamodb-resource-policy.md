...
ytofu resource for managing an AWS DynamoDB Resource Policy.
...
```bash
ytofu import aws_dynamodb_resource_policy.example arn:aws:dynamodb:us-east-1:1234567890:table/my-table
```
