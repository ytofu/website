...
* `description` - (Optional) The description of the Neptune parameter group. Defaults to "Managed by ytofu".
...
```bash
ytofu import aws_neptune_parameter_group.some_pg some-pg
```
