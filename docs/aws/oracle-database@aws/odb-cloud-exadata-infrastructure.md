...
ytofu resource for managing exadata infrastructure resource in AWS for Oracle Database@AWS.
...
```bash
ytofu import aws_odb_cloud_exadata_infrastructure.example example
```
