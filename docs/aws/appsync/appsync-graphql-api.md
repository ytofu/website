...
* `schema` - (Optional) Schema definition, in GraphQL schema language format. ytofu cannot perform drift detection of this configuration.
...
```bash
ytofu import aws_appsync_graphql_api.example 0123456789
```
