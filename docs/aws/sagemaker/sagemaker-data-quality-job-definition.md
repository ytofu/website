...
* `name` - (Optional) The name of the data quality job definition. If omitted, ytofu will assign a random, unique name.
...
```bash
ytofu import aws_sagemaker_data_quality_job_definition.test_data_quality_job_definition data-quality-job-definition-foo
```
