...
ytofu resource for managing an AWS Comprehend Entity Recognizer.
...
```bash
ytofu import aws_comprehend_entity_recognizer.example arn:aws:comprehend:us-west-2:123456789012:entity-recognizer/example
```
