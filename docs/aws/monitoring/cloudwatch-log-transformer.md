...
ytofu resource for managing an AWS CloudWatch Logs Transformer.
...
```bash
ytofu import aws_cloudwatch_log_transformer.example arn:aws:logs:us-west-2:123456789012:log-group:example
```
