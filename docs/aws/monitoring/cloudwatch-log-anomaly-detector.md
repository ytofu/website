...
ytofu resource for managing an AWS CloudWatch Logs Log Anomaly Detector.
...
```bash
ytofu import aws_cloudwatch_log_anomaly_detector.example log_anomaly_detector-arn-12345678
```
