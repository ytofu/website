...
ytofu resource for managing an AWS CloudWatch Observability Access Manager Link.
...
```bash
ytofu import aws_oam_link.example arn:aws:oam:us-west-2:123456789012:link/link-id
```
