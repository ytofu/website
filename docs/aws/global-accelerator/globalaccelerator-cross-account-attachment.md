...
ytofu resource for managing an AWS Global Accelerator Cross Account Attachment.
...
```bash
ytofu import aws_globalaccelerator_cross_account_attachment.example arn:aws:globalaccelerator::012345678910:attachment/01234567-abcd-8910-efgh-123456789012
```
