...
ytofu resource for managing an AWS CodeConnections Host.
...
```bash
ytofu import aws_codeconnections_host.example-host arn:aws:codeconnections:us-west-1:0123456789:host/79d4d357-a2ee-41e4-b350-2fe39ae59448
```
