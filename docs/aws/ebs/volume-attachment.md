...
time, and instead just remove the attachment from ytofu state. This is
...
```bash
ytofu import aws_volume_attachment.example /dev/sdh:vol-049df61146c4d7901:i-12345678
```
