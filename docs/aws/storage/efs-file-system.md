...
system creation. By default generated by ytofu. See [Elastic File System](http://docs.aws.amazon.com/efs/latest/ug/)
...
```bash
ytofu import aws_efs_file_system.foo fs-6fa144c6
```
