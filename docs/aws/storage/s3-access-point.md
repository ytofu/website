...
* `account_id` - (Optional) AWS account ID for the owner of the bucket for which you want to create an access point. Defaults to automatically determined account ID of the ytofu AWS provider.
...
```bash
ytofu import aws_s3_access_point.example 123456789012:example
```
