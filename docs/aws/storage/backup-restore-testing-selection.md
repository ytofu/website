...
ytofu resource for managing an AWS Backup Restore Testing Selection.
...
```bash
ytofu import aws_backup_restore_testing_selection.example restore_testing_selection_12345678:restore_testing_plan_12345678
```
