...
* `account_id` - (Optional) The AWS account ID for the S3 Storage Lens configuration. Defaults to automatically determined account ID of the ytofu AWS provider.
...
```bash
ytofu import aws_s3control_storage_lens_configuration.example 123456789012:example-1
```
