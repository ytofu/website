...
ytofu resource for managing an AWS IVS (Interactive Video) Channel.
...
```bash
ytofu import aws_ivs_channel.example arn:aws:ivs:us-west-2:326937407773:channel/0Y1lcs4U7jk5
```
