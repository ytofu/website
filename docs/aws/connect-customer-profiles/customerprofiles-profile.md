...
ytofu resource for managing an Amazon Customer Profiles Profile.
...
```bash
ytofu import aws_customerprofiles_profile.example domain-name/5f2f473dfbe841eb8d05cfc2a4c926df
```
