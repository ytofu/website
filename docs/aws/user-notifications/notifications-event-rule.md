...
ytofu resource for managing an AWS User Notifications Event Rule.
...
```bash
ytofu import aws_notifications_event_rule.example arn:aws:notifications::123456789012:configuration/abc123def456ghi789jkl012mno345/rule/abc123def456ghi789jkl012mno345
```
