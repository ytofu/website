...
ytofu resource for managing a Verified Access Logging Configuration.
...
```bash
ytofu import aws_verifiedaccess_instance_logging_configuration.example vai-1234567890abcdef0
```
