...
ytofu resource for managing an AWS Verified Permissions Identity Source.
...
```bash
ytofu import aws_verifiedpermissions_identity_source.example policy-store-id-12345678:identity-source-id-12345678
```
