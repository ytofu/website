...
For more information about building policy documents with ytofu, see the [AWS IAM Policy Document Guide](https://learn.hashicorp.com/terraform/aws/iam-policy).
...
```bash
ytofu import aws_kms_replica_external_key.example 1234abcd-12ab-34cd-56ef-1234567890ab
```
