...
ytofu resource for managing an AWS Security Lake Data Lake.
...
```bash
ytofu import aws_securitylake_data_lake.example arn:aws:securitylake:eu-west-1:123456789012:data-lake/default
```
