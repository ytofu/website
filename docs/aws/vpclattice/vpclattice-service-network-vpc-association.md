...
ytofu resource for managing an AWS VPC Lattice Service Network VPC Association.
...
```bash
ytofu import aws_vpclattice_service_network_vpc_association.example snsa-05e2474658a88f6ba
```
