# Resource: aws_eks_access_policy_associattion
...
```bash
ytofu import aws_eks_access_policy_association.my_eks_access_entry my_cluster_name#my_principal_arn#my_policy_arn
```
