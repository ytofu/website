...
* `name` - (Optional) The name of the launch template. If you leave this blank, ytofu will auto-generate a unique name.
...
```bash
ytofu import aws_launch_template.web lt-12345678
```
