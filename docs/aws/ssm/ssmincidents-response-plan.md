...
Provides a ytofu resource to manage response plans in AWS Systems Manager Incident Manager.
...
```bash
ytofu import aws_ssmincidents_response_plan.responsePlanName ARNValue
```
