...
Provides a ytofu resource for managing a Contacts Rotation in AWS Systems Manager Incident Manager.
...
```bash
ytofu import aws_ssmcontacts_rotation.example arn:aws:ssm-contacts:us-east-1:012345678910:rotation/example
```
