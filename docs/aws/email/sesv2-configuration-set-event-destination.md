...
ytofu resource for managing an AWS SESv2 (Simple Email V2) Configuration Set Event Destination.
...
```bash
ytofu import aws_sesv2_configuration_set_event_destination.example example_configuration_set|example_event_destination
```
