...
ytofu resource for managing an AWS Agents for Amazon Bedrock Agent Action Group.
...
```bash
ytofu import aws_bedrockagent_agent_action_group.example MMAUDBZTH4,GGRRAED6JP,DRAFT
```
