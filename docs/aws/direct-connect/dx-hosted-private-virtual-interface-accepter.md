...
However, ytofu only allows the Direct Connect hosted private virtual interface to be deleted from the allocator's side
...
```bash
ytofu import aws_dx_hosted_private_virtual_interface_accepter.test dxvif-33cc44dd
```
