...
* `policy` - (Optional) The fully-formed AWS policy as JSON. For more information about building AWS IAM policy documents with ytofu, see the [AWS IAM Policy Document Guide](https://learn.hashicorp.com/terraform/aws/iam-policy).
...
```bash
ytofu import aws_sns_topic.user_updates arn:aws:sns:us-west-2:123456789012:my-topic
```
