...
* `description` - (Optional) The description of the Origin Access Control. Defaults to "Managed by ytofu" if omitted.
...
```bash
ytofu import aws_cloudfront_origin_access_control.example E327GJI25M56DG
```
