...
ytofu resource for managing an AWS WorkSpaces Web Identity Provider.
...
```bash
ytofu import aws_workspacesweb_identity_provider.example arn:aws:workspaces-web:us-west-2:123456789012:identityprovider/abcdef12345678/12345678-1234-1234-1234-123456789012
```
