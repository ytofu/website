...
ytofu resource for managing an AWS WorkSpaces Web Portal.
...
```bash
ytofu import aws_workspacesweb_portal.example arn:aws:workspaces-web:us-west-2:123456789012:portal/abcdef12345678
```
